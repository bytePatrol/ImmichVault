...
struct OptimizerView: View {
    ...
    private var optimizerToolbar: some View {
        VStack(spacing: IVSpacing.sm) {
            ...
            HStack(spacing: IVSpacing.md) {
                ...
                Button {
                    ...
                    Image(systemName: "sidebar.trailing")
                        .foregroundColor(viewModel.showInspector ? .ivAccent : .ivTextSecondary)
                }
            ...
            // Config row: threshold, dates, preset, provider
            HStack(spacing: IVSpacing.lg) {
                ...
                // Provider picker + health indicator
                HStack(spacing: IVSpacing.xs) {
            ...
            // Filter row (when candidates exist)
